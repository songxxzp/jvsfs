...
class journal:
    ...
    def recoverable(self):
        return self.check() and len(self.queue) > 0

    def recover(self):  # TODO
        pass
...
class fs:
    ...
    def deleteFile(self, tfile):
        ...
        if self.inodes[inum].getRefCnt() == 1:
            ...
            self.journal.metadata(
                {
                    "fs": self,
                    "func": self.inodes[inum].decRefCnt,
                    "args": ()
                }
            )
        ...
        if ftype == 'd':
            self.journal.metadata(
                {
                    "fs": self,
                    "func": self.inodes[pinum].decRefCnt,
                    "args": ()
                }
            )
        ...
        self.journal.metadata(
            {
                "fs": self,
                "func": self.data[pblock].delDirEntry,
                "args": (tfile, )
            }
        )
    ...
    def createLink(self, target, newfile, parent):
        ...
        self.journal.metadata(
            {
                "fs": self,
                "func": self.inodes[tinum].incRefCnt,
                "args": ()
            }
        )
        ...
        self.journal.metadata(
            {
                "fs": self,
                "func": self.data[pblock].addDirEntry,
                "args": (ename, tinum, )
            }
        )
    ...
    def createFile(self, parent, newfile, ftype):
        ...
        if ftype == 'd':
            ...
            if fblock == -1:
                ...
                self.journal.metadata(
                    {
                        "fs": self,
                        "func": self.data[fblock].addDirEntry,
                        "args": ('.',  inum, )
                    }
                )
        ...
        self.journal.metadata(
            {
                "fs": self,
                "func": self.inodes[inum].setAll,
                "args": (ftype, fblock, refCnt, )
            }
        )
        ...
        if ftype == 'd':
            self.journal.metadata(
                {
                    "fs": self,
                    "func": self.inodes[parentInum].incRefCnt,
                    "args": ()
                }
            )
            # self.inodes[parentInum].incRefCnt()
